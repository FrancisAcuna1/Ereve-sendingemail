...
<body style="background-Color: whiteSmoke ">
    <div class="container contact-form">
            ...
            <form id="contact-form" role="form"  action="sending" method="post"  enctype="multipart/form-data" autocomplete="off">
            @csrf
               ...
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="file" name="file" class="form-control" placeholder="Your your file*" />
                        </div>
                        <div class="form-group">
